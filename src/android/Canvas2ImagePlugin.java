package tw.com.moralist.yiharng.canvas2image;
...
public class Canvas2ImagePlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        this.directory = args.optString(2);
        this.filename = args.optString(3);
    ...
    private void savePhoto() {
        ...
        {
            this.filename=System.currentTimeMillis() + (this.format.equals("png") ? ".png" : ".jpg");
        }
        ...
        try {
            ...
            contentValues.put(MediaStore.MediaColumns.DISPLAY_NAME, this.filename);
            ...
            if (!this.directory.equals(""))
            {
                contentValues.put(MediaStore.MediaColumns.RELATIVE_PATH
                    ,Environment.DIRECTORY_PICTURES+"/"+this.directory);
            }
